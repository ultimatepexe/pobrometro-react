    ...
    return (
        <header className="text-white max-w-[800px] min-w-[320px] justify-self-center p-[5px] font-semibold font-sans">
            ...
            <div className="flex max-w-[800px] gap-1 m-1">
                ...
                <input type="number" placeholder="0" min="0" max="999999999999999" maxLength={15} className={`${theme ? 'bg-neutral-900 placeholder-neutral-400 text-white' : 'bg-neutral-200 placeholder-neutra-900 text-black'} w-full rounded-md p-2`}/>
                <button className="bg-yellow-400 text-black p-2 rounded-md cursor-pointer hover:bg-yellor-500 active:bg-yellow-600 active:scale-97 transition-transform">
                    CONVERTER
                </button>
            </div>
        </header>
